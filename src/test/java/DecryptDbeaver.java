...
public class DecryptDbeaver {
    ...
    @Test
    public void test01() throws IOException, InvalidAlgorithmParameterException, NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException {
        String path = "C:\\Users\\Asus\\AppData\\Roaming\\DBeaverData\\workspace6\\General\\.dbeaver\\credentials-config.json";



        System.out.println(decrypt(Files.readAllBytes(Path.of(path))));
    }
